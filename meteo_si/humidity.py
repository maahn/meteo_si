...
def e_sat_gg_water(T):
    '''
    Calculates the saturation pressure over water after Guide to Meteorological Instruments and Methods of Observation (CIMO Guide) 
    (WMO, 2008).
...
def e_sat_gg_ice(T):
    '''
    Calculates the saturation pressure over ice after Guide to Meteorological Instruments and Methods of Observation (CIMO Guide) 
    (WMO, 2008).
